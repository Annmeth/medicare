...
<div class="main-panel">
   ...
   All  Equipment & Supplies Monthly Report </div>
  	  			<div class="panel-body">
              <!-- main content -->
              <b>Filter:</b>
                <select class="btn btn-default" id="report-choice">
                  <option value="all">All </option>
                  <option value="department">ST100</option>
                  <option value="department">ST200</option>
                  <option value="department">ST300</option>
                  <option value="department">ST300</option>
                </select>
                        ...
                        <?php
                                     ...
                                     ?>
                                               ...
                                               <tr>
                                                   ...
                                                   <td>
                                                   <a href="view_Store_report.php" class="btn btn-outline-primary">View Report</a>
                                                   </td>
                                               </tr>
                                               <?php
